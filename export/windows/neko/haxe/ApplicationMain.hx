...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "LittleDudes", "com.example.myapp", "0.0.1");
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (random.littledudes.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (random.littledudes.Main, Reflect.field (random.littledudes.Main, "main"), []);
...
@:keep class DocumentClass extends random.littledudes.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "LittleDudes", null, { width: 800, height: 600 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (random.littledudes.Main, []);
			}
...
import random.littledudes.Main;
